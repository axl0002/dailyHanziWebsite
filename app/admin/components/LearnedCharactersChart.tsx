        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 md:col-span-2 lg:col-span-1">
            <div className="mb-6">
                <div className="flex items-baseline justify-between">
                    <h3 className="text-lg font-bold text-gray-900">Characters Learned per User</h3>
                    <span className="text-xs text-gray-500">{activeUsers.toLocaleString()} of {poolTotal.toLocaleString()} Pro users learned ≥1 ({rangeLabel})</span>
                </div>
                <p className="text-xs text-gray-500 mt-1">Strength 3 in user_seen_characters — max mastery level.</p>
            </div>
                                ...
                                if (active && payload && payload.length) {
                                    ...
                                    return (
                                        <div className="bg-white p-3 border border-gray-100 shadow-lg rounded-xl min-w-[150px]">
                                            <p className="font-semibold text-gray-900 mb-2">{label} characters learned</p>
